    ...
    <main id="main">
        ...
        <div>
            <section style="margin-bottom: 4rem;">
                <h2 style="font-weight: 700; color: black; margin-top: 3rem; margin-bottom: 2rem;">Electronic
                    </h2>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Experience seamless electronic solutions with our dedicated service providers, delivering expert services for all your electronic needs. From precise TV installation and efficient repair to professional TV mounting, our technicians ensure a flawless entertainment setup. <br><br>Keep your home comfortable with our air conditioner installation and reliable service and repair solutions. Elevate your entertainment experience with our home theater AV setup, bringing cinematic quality to your living spaces. <br><br>Ensure the safety of your property with our CCTV installation services, providing advanced surveillance solutions. Step into the future with our smart home services, seamlessly integrating cutting-edge technology. <br><br>Trust our skilled technicians to deliver top-notch electronic services, transforming your home with precision and expertise.</p>
                                </div>
                            </div>

                        </div>
                        <div class="col">
                            <img src="./assets/images/electronic.jpg" class="img-fluid rounded"
                            ...
                            <div style="text-align: center;">
                                <button type="button" class="btn btn-success btn-lg"
                                    style="font-weight: 700; padding-left: 4rem; padding-right: 4rem;" onclick="location.href='electronicform.php';">book now</button>
                            </div>
            ...
            <section id="sectionthree">
                <div id="sectionthreein">
                    <div class="container text-left">
                        <div class="row align-items-start">
                            <div class="col">
                                <img src="./assets/images/electronic.jpg" class="img-fluid rounded" alt="...">
                            </div>
                            <div class="col">
                                <br>
                                <br>
                                <br>
                                <h2 style="font-weight: 700; color: black;">Ready to hire an electronic service provider ?</h2>
                                <br>
