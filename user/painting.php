    ...
    <main id="main">
        ...
        <div>
            <section style="margin-bottom: 4rem;">
                <h2 style="font-weight: 700; color: black; margin-top: 3rem; margin-bottom: 2rem;">Painting
                    </h2>
                ...
                <div class="container text-left">
                    <div class="row align-items-start">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Revitalize your living spaces with our expert set of service providers dedicated to delivering top-notch painting solutions. Whether you're seeking a refreshing interior makeover or an exterior transformation, our skilled painters offer a comprehensive range of services to cater to your aesthetic preferences.<br><br> From bedroom painting to accent wall creations, we tailor our expertise to bring your unique vision to life. Elevate the finer details with our baseboard, doorframe, door, and crown molding painting services, adding a touch of sophistication to every corner of your home. <br><br>When it comes to the exterior, our team is committed to enhancing curb appeal, ensuring your property stands out with vibrant and enduring colors. With our expert set of service providers, we bring your ideas to life, turning your space into a canvas of personal expression. Trust us to deliver impeccable results and make your painting dreams a colorful reality.</p>
                        ...
                        <div class="col">
                            <img src="./assets/images/painting.png" class="img-fluid rounded"
                            ...
                            <div style="text-align: center;">
                                <button type="button" class="btn btn-success btn-lg"
                                    style="font-weight: 700; padding-left: 4rem; padding-right: 4rem;" onclick="location.href='paintingform.php';">book now</button>
                            </div>
            ...
            <section id="sectionthree">
                <div id="sectionthreein">
                    <div class="container text-left">
                        <div class="row align-items-start">
                            <div class="col">
                                <img src="./assets/images/painting.png" class="img-fluid rounded" alt="...">
                            </div>
                            <div class="col">
                                <br>
                                <br>
                                <br>
                                <h2 style="font-weight: 700; color: black;">Ready to hire a painter ?</h2>
                                <br>

                                <button type="button" class="btn btn-success btn-lg"
                                    style="font-weight: 700; padding-left: 4rem; padding-right: 4rem;" onclick="location.href='paintingform.html';">book now</button>
