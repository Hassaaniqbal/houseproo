    ...
    <main id="main">
        ...
        <div>
            <section style="margin-bottom: 4rem;">
                <h2 style="font-weight: 700; color: black; margin-top: 3rem; margin-bottom: 2rem;">Cleaning &
                    Maintenance</h2>
                ...
                <div class="container text-left">
                    <div class="row align-items-start">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">We connect you with expert cleaners dedicated to elevating the
                                        cleanliness and allure of your living spaces. From routine maintenance to
                                        in-depth cleaning, our platform offers a suite of services designed to cater to
                                        all your needs. <br><br>Whether it's your bedroom, apartment, or office, our
                                        professional cleaners ensure a meticulous approach, leaving no corner untouched.
                                        <br><br>Moving in or moving out? Our specialized services have got you covered.
                                        Need a deep cleaning service, kitchen overhaul, or living room revitalization?
                                        Look no further. We go beyond the basics, offering roof cleaning and home
                                        sanitization to create a healthier and more inviting environment. <br><br>Choose
                                        our maid service for a consistent, top-notch cleaning experience. Your
                                        satisfaction is our priority, and we're here to make every space spotless and
                                        inviting.</p>
                        ...
                        <div class="col">
                            <img src="./assets/images/cleaning.jpg" class="img-fluid rounded"
                            ...
                            <div style="text-align: center;">
                                <button type="button" class="btn btn-success btn-lg"
                                    style="font-weight: 700; padding-left: 4rem; padding-right: 4rem;" onclick="location.href='cleaningform.php';">book now</button>
                            </div>
            ...
            <section id="sectionthree">
                <div id="sectionthreein">
                    <div class="container text-left">
                        <div class="row align-items-start">
                            <div class="col">
                                <img src="./assets/images/cleaning.jpg" class="img-fluid rounded" alt="...">
                            </div>
                            <div class="col">
                                <br>
                                <br>
                                <br>
                                <h2 style="font-weight: 700; color: black;">Ready to hire a cleaner ?</h2>
                                <br>

                                <button type="button" class="btn btn-success btn-lg"
                                    style="font-weight: 700; padding-left: 4rem; padding-right: 4rem;" onclick="location.href='cleaningform.html';">book now</button>
