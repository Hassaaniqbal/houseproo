            ...
            <section style="margin-bottom: 4rem;">
                ...
                <div class="container text-left">
                    <div class="row align-items-start">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Embark on a worry-free plumbing journey with our comprehensive range of expert services tailored to meet all your plumbing needs. From drain repairs to faucet installations, our skilled professionals are adept at resolving any plumbing issue efficiently.<br><br> Need a faucet repaired or replaced? We've got you covered. Sink replacement, toilet repair, and replacement services are seamlessly executed to ensure optimal functionality. Our experts specialize in unclogging toilets, providing swift solutions to keep your plumbing in top shape. <br><br>Looking to upgrade your rainwater system? Count on us for reliable installation and maintenance. With a commitment to excellence, we strive to deliver unparalleled service in every aspect of plumbing, ensuring that your home functions smoothly. Trust us to address all your plumbing concerns with precision and expertise.</p>
                        ...
                        <div class="col">
                            <img src="./assets/images/plumbing.jpg" class="img-fluid rounded"
                            ...
                            <div style="text-align: center;">
                                <button type="button" class="btn btn-success btn-lg"
                                    style="font-weight: 700; padding-left: 4rem; padding-right: 4rem;" onclick="location.href='plumbingform.php';">book now</button>
                            </div>
            ...
            <section id="sectionthree">
                <div id="sectionthreein">
                    <div class="container text-left">
                        <div class="row align-items-start">
                            <div class="col">
                                <img src="./assets/images/plumbing.jpg" class="img-fluid rounded" alt="...">
                            </div>
                            <div class="col">
                                <br>
                                <br>
                                <br>
                                <h2 style="font-weight: 700; color: black;">Ready to hire a plumber ?</h2>
                                <br>

                                <button type="button" class="btn btn-success btn-lg"
                                    style="font-weight: 700; padding-left: 4rem; padding-right: 4rem;" onclick="location.href='plumbingform.html';">book now</button>
