...
<header>
    ...
    <main id="main">
        <section>
            <h2 style="font-weight: 700; color: black; margin-top: 3rem; margin-bottom: 2rem;">Painting</h2>
    ...
    var serviceType = "Painting"; // Assuming plumbing is the service type
