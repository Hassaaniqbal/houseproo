...
if (isset($_POST['delete_provider_id'])) {
    ...
    $delete_documents_query = "DELETE FROM freelance_sp_documents WHERE provider_id = '$delete_provider_id'";
    ...
    if ($mysqli->query($delete_documents_query)) {
        ...
        $delete_query = "DELETE FROM freelance_service_provider WHERE provider_id = '$delete_provider_id'";
