...
if(isset($_POST['providerId'])) {
    ...
    $updateSuccess = $mysqli->query("UPDATE company_service_provider SET status = 'approved' WHERE provider_id = '$providerId'");
...
function sendApprovalEmail($providerId, $mysqli) {
    $detailsQuery = "SELECT firstname, lastname, email FROM company_service_provider WHERE provider_id = '$providerId'";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $emailMessage .= "<b>We are thrilled to inform you that your application to become a service provider through our household service web application has been successful! Congratulations from the entire team at House Pro!

        You are now officially approved to offer your services to our valued customers. To get started, please visit our website and set up your profile. Once your profile is complete, you can begin providing your services to customers in need.
        We are confident that your expertise and skills will greatly benefit our platform and our customers. Thank you for choosing to join House Pro as a service provider.
