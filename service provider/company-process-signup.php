...
$email_check_query = "SELECT COUNT(*) FROM company_service_provider WHERE email = ?";
...
$sql = "INSERT INTO company_service_provider (firstname, lastname, number, category, area, email, password)
        VALUES (?, ?, ?, ?, ?, ?, ?)";
