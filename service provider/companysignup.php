    ...
    <section>
        <div class="card" id="registerform" style="margin-top: 9rem">
            <div class="card-body">
                ...
                <form action="company-process-signup.php" method="post" onsubmit="return validateForm()" novalidate>
                ...
                <?php endif; ?>
                    ...
                    <div class="form-check d-flex justify-content-left mb-4">
                        ...
                        <label class="form-check-label" for="form6Example8"> I acknowledge i am a company based service
                            provider </label>
                    </div>
